...
<head>
<meta charset="UTF-8">
<title>تسجيل الدخول — Draw Bot</title>
...
<main class="auth-page">
  <div class="auth-box">
    ...
    <p class="auth-sub">سجّل الدخول للوصول إلى لوحة التحكم</p>
    ...
    <div class="auth-divider">أو بالبريد وكلمة المرور</div>
    ...
    <div class="auth-link">ليس لديك حساب؟ <a href="/register">إنشاء حساب جديد</a></div>
  </div>
</main>
